...
class SettingFrame(ttk.LabelFrame):
    def __init__(self, master, model, theme, nx_installation_path, customer_environment_path, licence_path, licence_server_path, icon, editor, batchstart, *args, **kwargs):
        ...
        ttk.Label(self, text="Lizenzpfad:").grid(row=2, column=0, padx=20, pady=20)
        ...
        ttk.Label(self, text="Lizenz Server Pfad:").grid(row=3, column=0, padx=20, pady=20)
        ...
        ttk.Label(self, text="Farbschema anpassen:").grid(row=4, column=0, padx=20, pady=20)
        ...
        ttk.Label(self, text="Text Editor:").grid(row=5, column=0, padx=20, pady=20)
        ...
        self.batchstart_check.grid(row=6, column=1, sticky="w", pady=30)

        self.return_btn = tk.Button(self, text="Zurück", width=15)
        self.return_btn.grid(row=7, column=2)
