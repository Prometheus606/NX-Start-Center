...
class View(tk.Tk):
    def __init__(self, model):
        ...
        self.setting_frame = SettingFrame(self, self.model, self.theme, self.nx_installation_path, self.customer_environment_path, self.licence_path, self.licence_server_path, "src/images/folder.png", self.editor, self.batchstart, self.use_role, text="Einstellungen")
